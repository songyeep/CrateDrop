...
Item.create(name: 'Laputa: Castle in the Sky Robot Soldier ', price: 15, description: 'Little boys are just super heroes in disguise', crate: box2, remote_image_url: 'http://media-cache-ak0.pinimg.com/736x/16/ad/9d/16ad9d3f51c79272acc02e3cd7875dcf.jpg')
...
Item.create(name: 'Jimi Hendrix Vinyl CLock', price: 10, description: 'Jimi Hendrix gift wall clock from vinyl record rock unique lsd woodstock handmade', crate: box3, remote_image_url: 'https://img1.etsystatic.com/000/0/6817036/il_570xN.341176669.jpg')
...
Item.create(name: 'I Love Scrump T-shirt', price: 10, description: 'A t-shirt that says it all.', crate: box7, remote_image_url: 'http://media.fbxcdn.com/pic/p6785_column_grid_12.jpg')
...
Item.create(name: 'The Ice Baller', price: 20, description: 'Make striking crystal-clear ice orbs in your own home', crate: box8, remote_image_url: 'http://media.fbxcdn.com/pic/p6610_column_grid_12.jpg')
...
Item.create(name: 'Blade Runner Whiskey Glass', price: 10, description: 'I drink Sebastian, therefor I am', crate: box8, remote_image_url: 'http://media.fbxcdn.com/pic/p4346_column_grid_12.jpg')
